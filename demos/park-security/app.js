import { createInitialEvents, shiftContext } from "./mock-data.js";
    ...
    (() => {
      ...
      function updateLocalDashboardVisibility() { elements.localPanels.forEach((panel) => { panel.hidden = !demoMode; }); }
      function render() { updateLocalDashboardVisibility(); renderKpis(); renderEventList(); renderEventDetail(); renderTimeline(); renderShiftContext(); }
